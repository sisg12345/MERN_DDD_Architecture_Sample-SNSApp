...
import { IGetUserHandler } from '@/application/useCase/user/getUser/IGetUserHandler'
import { GetUserHandler } from '@/application/useCase/user/getUser/getUserHandler'
import { IUserService } from '@/domain/interfaces/services/IUserService'
import { UserService } from '@/domain/services/userService'
import { IUpdateUserHandler } from '@/application/useCase/user/updateUser/IUpdateUserHandler'
import { UpdateUserHandler } from '@/application/useCase/user/updateUser/updateUserHandler'
import { IDeleteUserHandler } from '@/application/useCase/user/deleteUser/IDeleteUserHandler'
import { DeleteFollowerHandler } from '@/application/useCase/user/deleteFollower/deleteFollowerHandlerHandler'
import { ICreateFollowerHandler } from '@/application/useCase/user/createFollower/ICreateFollowerHandler'
...
import { IDeleteFollowerHandler } from '@/application/useCase/user/deleteFollower/IDeleteFollowerHandlerHandler'
